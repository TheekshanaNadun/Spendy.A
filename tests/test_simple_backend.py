#!/usr/bin/env python3
"""
Simplified backend tests for Spendy.AI
These tests use proper database configuration
"""
...
class SimpleBackendTests(unittest.TestCase):
    """Simplified backend tests with proper database setup"""
    ...
    def tearDown(self):
        ...
        cleanup_test_environment(self.db_path)
